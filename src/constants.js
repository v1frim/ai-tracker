...
export const SKILLS = [
  { id: "llm", name: "LLM / Чат-боти", emoji: "🧠", color: "#00ff88",
    tools: [
      { name: "Claude",    url: "https://claude.ai/new",               active: true  },
      { name: "ChatGPT",   url: "https://chatgpt.com/",                active: true  },
      { name: "Gemini",    url: "https://gemini.google.com/app",        active: true  },
      { name: "Grok",      url: "https://grok.com/",                   active: true  },
      { name: "Syntx",     url: "https://syntx.ai/ru/text/claude",      active: true  },
      { name: "Mistral",   url: "https://chat.mistral.ai/",            active: false },
  ...
  { id: "aggregators", name: "Агрегатори", emoji: "🎛️", color: "#84cc16",
    tools: [
      ...
      { name: "Pletor",     url: "https://app.pletor.ai/?tab=continue",                                                 active: true },
    ],
  },
  ...
  { id: "video", name: "Генерація відео", emoji: "🎬", color: "#a855f7",
    tools: [
      { name: "Higgsfield", url: "https://higgsfield.ai/",                                                                                                                     active: true  },
      { name: "Syntx",      url: "https://syntx.ai/ru/video/seedance",                                                                                                                          active: true  },
      { name: "Seedance",   url: "https://seedance2.ai/uk",                                                                                                                    active: true  },
      { name: "Kling",      url: "https://kling.ai/app",                                                                                                                       active: true  },
      { name: "Runway",     url: "https://app.runwayml.com/video-tools/teams/vovabestintheworld4/ai-tools/generate?mode=apps",                                                 active: true  },
      { name: "Grok",       url: "https://grok.com/",                                                                                                                          active: true  },
      { name: "Sora",       url: "https://sora.com/",                                                                                                                          active: false },
      { name: "Pika",       url: "https://pika.art/",                                                                                                                          active: false },
      { name: "Luma",       url: "https://lumalabs.ai/dream-machine",                                                                                                          active: false },
      { name: "HeyGen",     url: "https://app.heygen.com/",                                                                                                                    active: false },
    ],
  },
  { id: "voice", name: "Голос / Аудіо", emoji: "🎙️", color: "#06b6d4",
    tools: [
      { name: "ElevenLabs", url: "https://elevenlabs.io/app/home", active: true  },
      { name: "Higgsfield", url: "https://higgsfield.ai/",         active: true  },
      { name: "Syntx",      url: "https://syntx.ai/ru/audio/elevenlabs",              active: true  },
      { name: "PlayHT",     url: "https://play.ht/",               active: false },
      { name: "Murf AI",    url: "https://murf.ai/",               active: false },
    ],
  },
  { id: "music", name: "Музика", emoji: "🎵", color: "#ec4899",
    tools: [
      { name: "Suno",     url: "https://suno.com/",            active: true  },
      { name: "Udio",     url: "https://www.udio.com/",        active: false },
      { name: "AIVA",     url: "https://www.aiva.ai/",         active: false },
      { name: "Boomy",    url: "https://boomy.com/",           active: false },
      { name: "Beatoven", url: "https://www.beatoven.ai/",     active: false },
    ],
  },
  { id: "automation", name: "Автоматизація / Агенти", emoji: "⚙️", color: "#f59e0b",
    tools: [
      { name: "n8n",       url: "https://n8n.io/",                               active: false },
      { name: "Make",      url: "https://www.make.com/",                         active: false },
      { name: "Zapier",    url: "https://zapier.com/",                           active: false },
      { name: "LangGraph", url: "https://langchain-ai.github.io/langgraph/",    active: false },
      { name: "CrewAI",    url: "https://www.crewai.com/",                       active: false },
      { name: "AutoGen",   url: "https://microsoft.github.io/autogen/",         active: false },
    ],
  },
  { id: "code", name: "Код / Боти", emoji: "💻", color: "#6366f1",
    tools: [
      { name: "Claude Code",    url: "https://claude.ai/code",                  active: false },
      { name: "GitHub Copilot", url: "https://github.com/features/copilot",     active: false },
      { name: "Cursor",         url: "https://www.cursor.com/",                 active: false },
      { name: "Vercel",         url: "https://vercel.com/",                     active: false },
      { name: "Railway",        url: "https://railway.app/",                    active: false },
      { name: "Codex",          url: "https://openai.com/codex",               active: false },
    ],
  },
  { id: "design", name: "AI Дизайн", emoji: "✨", color: "#f43f5e",
    tools: [
      { name: "Canva AI",      url: "https://www.canva.com/",         active: false },
      { name: "Adobe Firefly", url: "https://firefly.adobe.com/",     active: false },
      { name: "Looka",         url: "https://looka.com/",             active: false },
  ...
  { id: "content", name: "Контент / Публікації", emoji: "📱", color: "#10b981",
    tools: [
      { name: "CapCut AI", url: "https://www.capcut.com/",    active: false },
      { name: "OpusClip",  url: "https://www.opus.pro/",      active: false },
      { name: "Buffer",    url: "https://buffer.com/",        active: false },
      { name: "Hootsuite", url: "https://hootsuite.com/",     active: false },
      { name: "Metricool", url: "https://metricool.com/",     active: false },
    ],
  },
  { id: "monetize", name: "Монетизація", emoji: "💰", color: "#fbbf24",
    tools: [
      { name: "Gumroad",       url: "https://gumroad.com/",              active: false },
      { name: "LemonSqueezy",  url: "https://www.lemonsqueezy.com/",     active: false },
      { name: "Ko-fi",         url: "https://ko-fi.com/",                active: false },
      { name: "Stripe",        url: "https://stripe.com/",               active: false },
      { name: "Paddle",        url: "https://www.paddle.com/",           active: false },
      { name: "Etsy",          url: "https://www.etsy.com/",             active: false },
    ],
  },
];
...
export const YT_CHANNELS = [
  ...
  { handle: "syntxai",          name: "SYNTX.AI",       channelId: "UCmxeYVU2qMS-w5G3QQpQ1tA" },
];
